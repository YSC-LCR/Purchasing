...
export default {
  ...
  data() {
    return {
      ...
      // columnTypeOptions: [
      //   { key: 'categoryName', display_name: '檔期名稱' },
      //   { key: 'eventName', display_name: '活動名稱' },
      //   { key: 'eventStatus', display_name: '行銷活動 狀態' },
      //   { key: 'deptId', display_name: '部門' },
      //   { key: 'epccStatus', display_name: '部門商品碼 狀態' }
      // ],
    }
  },
  methods: {
