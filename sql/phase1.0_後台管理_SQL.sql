...
-- ----------------------------
-- Records of backend_prod
-- ----------------------------
CREATE TABLE `eladmin`.`backend_prod` (
  `prod_id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '商品流水號',
  `prod_name` VARCHAR(255) NULL DEFAULT NULL COMMENT '商品名稱',
  `prod_desc` VARCHAR(255) NULL DEFAULT NULL COMMENT '商品描述',
  `weight` INT NULL DEFAULT NULL COMMENT '重量',
  `can_fly` VARCHAR(2) NULL DEFAULT NULL COMMENT '可空運(Y:1/N:0)',
  `can_sea` VARCHAR(2) NULL DEFAULT NULL COMMENT '可海運(Y:1/N:0)',
  `create_by` VARCHAR(255) NULL DEFAULT NULL COMMENT '建立者',
  `create_date` VARCHAR(255) NULL DEFAULT NULL COMMENT '建立日期',
  `update_by` VARCHAR(255) NULL DEFAULT NULL COMMENT '修改者',
  `update_date` VARCHAR(255) NULL DEFAULT NULL COMMENT '修改時間',
  `sub_category_id` BIGINT NULL DEFAULT NULL COMMENT '副類別序號 from backend_prod_sub_category',
  `deleteFlag` VARCHAR(2) NULL DEFAULT NULL COMMENT '邏輯刪除(Y:1/N:0)',
  PRIMARY KEY (`prod_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
